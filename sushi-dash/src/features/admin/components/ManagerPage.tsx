...
import { UI_TEXT, SEOHead } from "@/features/shared";
import { TableManager, MenuManager, OrderSettingsManager } from "@/features/admin";
import { CollapsibleSection } from "@/features/customer";
const ManagerPage = () => {
  const {
    menu,
    categories,
